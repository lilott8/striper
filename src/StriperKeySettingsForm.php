...
class StriperKeySettingsForm extends ConfigFormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $form['striper_test_keys']['test_secret_key'] = array(
            ...
            '#default_value' => $this->getKey(StriperKeySettingsForm::STRIPE_TEST_SK),
            '#size' => 60,
            '#maxlength' => 128,
            '#required' => TRUE,
        ...
        $form['striper_test_keys']['test_publishable_key'] = array(
            ...
            '#default_value' => $this->getKey(StriperKeySettingsForm::STRIPE_TEST_PK),
            '#size' => 60,
            '#maxlength' => 128,
            '#required' => TRUE,
            '#attributes' => array('readonly' => 'readonly'),
        ...
        $form['striper_live_keys']['live_secret_key'] = array(
            ...
            '#default_value' => $this->getKey(StriperKeySettingsForm::STRIPE_LIVE_SK),
            '#size' => 60,
            '#maxlength' => 128,
            '#attributes' => array('readonly' => 'readonly'),
        );
        ...
        $form['striper_live_keys']['live_publishable_key'] = array(
            ...
            '#default_value' => $this->getKey(StriperKeySettingsForm::STRIPE_LIVE_PK),
            '#size' => 60,
            '#maxlength' => 128,
            '#attributes' => array('readonly' => 'readonly'),
        );
